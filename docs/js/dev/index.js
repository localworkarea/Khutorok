...
function initSliders() {
  ...
  if (document.querySelector(".section-3__slider")) {
    const sliderEl = document.querySelector(".section-3__slider");
    new Swiper(sliderEl, {
...
class FullPage {
  ...
  setEvents() {
    ...
    const nextArrowBtns = document.querySelectorAll(".section-1__btn");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (sectionWrapper) {
    ...
    var showRandom = showRandom2;
    const parentSection = sectionWrapper.closest(".section--main");
    document.querySelector(".section-2__body");
